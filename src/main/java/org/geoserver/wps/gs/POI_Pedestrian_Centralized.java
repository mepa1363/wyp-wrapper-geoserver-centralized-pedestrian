...
@DescribeProcess(title = "POI-WPS", description = "POI WPS - Network-based approach (Pedestrian)")
public class POI_Pedestrian_Centralized implements GSProcess {
	...
	public static String CallPOIService(String walkshed) {
		...
		try {
			url_string = "http://127.0.0.1:8365/poi?walkshed=" + walkshed;
